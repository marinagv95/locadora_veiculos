    ...
    public static void exibirMenuAluguel(){
        String menu =
                ANSI_YELLOW + "\n╔══════════════════════════════════╗" + ANSI_RESET + "\n" +
                        ...
                        ANSI_YELLOW + "║" + ANSI_RESET + ANSI_WHITE + "  2. ✏️            " + ANSI_RESET + ANSI_YELLOW +"║" + ANSI_RESET + "\n" +
                        ANSI_YELLOW + "║" + ANSI_RESET + ANSI_WHITE + "  3. 🔍             " + ANSI_RESET + ANSI_YELLOW +"║" + ANSI_RESET + "\n" +
                        ANSI_YELLOW + "║" + ANSI_RESET + ANSI_WHITE + "  4. 🗑️            " + ANSI_RESET + ANSI_YELLOW +"║" + ANSI_RESET + "\n" +
                        ANSI_YELLOW + "╠══════════════════════════════════╣" + ANSI_RESET + "\n" +
